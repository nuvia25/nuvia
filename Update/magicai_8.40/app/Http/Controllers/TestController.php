...
use App\Extensions\ChatbotMultiChannel\System\Services\Telegram\TelegramService;
...
class TestController extends Controller
{
    public function test(Request $request)
    {
        ...
        $chatbotChannel = ChatbotChannel::query()->where('channel', 'telegram')->first();

        (new TelegramService)->setChannel($chatbotChannel)->sendText('hello', '870364707');
    }
